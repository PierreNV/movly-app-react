...
const Home = () => {
	return <div className="mb-2">
		...
		<p>The movies page is all about filtering, sorting and displaying the correct data according to the user preference. Lodash utility functions helped me simplifying this task thanks to methods chaining and the range method. As mentionned earlier, you have the possiblity to edit the data by clicking on the movie title of your choice once you are logged in. Entries are checked against a validation schema before being transmitted to the server.</p>
		...
		<p>Finally, the style and layout is handle with bootstrap for efficiency. It is minimalist and mobile first library, it gives a consistent experience to the user on various medias.</p>
	</div>;
};
